                            ...
                            Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${me.role} · ${shortAC(me.constituency)} · Home ward ${me.homeWard}',
                                    style: const TextStyle(
                                        fontSize: 11,
                        ...
                        Row(
                          children: [
                            for (final (label, count) in [
                              ('Assigned', _mineAllWards.length),
                              ('Escalated',
                                  _mineAllWards.where((i) => i.escalatedAt != null && i.status != 'CLOSED' && i.status != 'FALSE').length),
                              ('Resolved',
                                  _mineAllWards.where((i) => i.status == 'CLOSED').length),
                              ('False',
                                  _mineAllWards.where((i) => i.status == 'FALSE').length),
                            ]) ...[
                              Expanded(
                                child: Container(
                                  padding: const EdgeInsets.symmetric(
