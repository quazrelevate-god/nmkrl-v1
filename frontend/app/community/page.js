...
/**
 * Community — the social surface (feed, stories, polls, threaded comments).
 * Mounted at /community rather than the app root: the phase-1 map home keeps
 * "/" so both surfaces coexist instead of one replacing the other.
